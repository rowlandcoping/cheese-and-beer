...
urlpatterns = [
    path('add-cheese-category/', views.add_cheese_category, name='add_cheese_category'),
    path('add-beer-category/', views.add_beer_category, name='add_beer_category'),
    ...
    path('publish-product/<int:product_id>/', views.product_publish, name='product_publish'),
    path('unpublish-product/<int:product_id>/', views.product_unpublish, name='product_unpublish'),
]